        ...
        <GenericBoxVisible>
            {#if userData}
                <div class="p-6 space-y-6">
                    ...
                    <div class="flex gap-4 items-start border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3 mb-3">
                                <span
                                    class="text-sm bg-red-800 dark:bg-red-900 rounded-md px-2 py-1 font-bold text-white"
                                >
                                ...
                                >
                                    <img
                                        ...
                                        height="20"
                                        class="inline mr-2"
                                    />{userData.cvInfo?.englishLevel || 'N/A'} English
                                </span>
                                {#if userData.cvInfo?.worksInIt}
                                    <span
                                        class="text-xs bg-green-600 dark:bg-green-700 rounded-md px-2 py-1 font-bold text-white"
                                    >
                                        Currently Working
                                    </span>
                                {/if}
                    ...
                    <!-- ************  Quick Stats ****************  -->
                    <div
                        class="flex items-center justify-evenly gap-4 pt-4 border-t border-gray-200 dark:border-gray-700"
                    >

			...
			<div class="p-6 space-y-6">
				...
				<div class="flex items-center justify-evenly gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
					<div class="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
						<p class="text-2xl font-bold text-primary-600 dark:text-primary-400">{techTags.length}</p>
						<p class="text-sm text-gray-600 dark:text-gray-400">Technologies</p>
					</div>
					<div class="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
						<p class="text-2xl font-bold text-primary-600 dark:text-primary-400">Cohort {userData.cohort}</p>

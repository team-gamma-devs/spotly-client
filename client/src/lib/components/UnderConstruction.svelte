...
>
    ...
    >
        <h2 class="text-base sm:text-lg md:text-xl lg:text-[1.5dvw]">COMING SOON!</h2>
        <h1 class="text-3xl sm:text-4xl md:text-6xl lg:text-[5dvw] font-bold mt-2">SPOTLY</h1>
        <div class="countdown-container bg-black/30 backdrop-blur-sm rounded-lg p-4 sm:p-6 md:p-8 my-4 sm:my-6 md:my-8">
            <div class="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6 text-center">
                <div class="countdown-item">
                    <div class="text-xl sm:text-3xl md:text-4xl lg:text-[2dvw] font-bold text-white">
                        {timeLeft.days.toString().padStart(2, '0')}
                    </div>
                    <div class="text-xs sm:text-sm md:text-base lg:text-[0.8dvw] text-gray-300 uppercase tracking-wider">
                        Days
                    </div>
                </div>
                <div class="countdown-item">
        ...
        <h3 class="text-sm sm:text-base md:text-lg lg:text-[1dvw]">Team Gamma Devs</h3>
    </div>
